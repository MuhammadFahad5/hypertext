                    ...
                    <div className='my-col'>
                        <div className=' mb-6 md:mb-8 flex justify-between items-center flex-wrap'>
                            <div className='flex gap-8 items-center flex-wrap'>
                                <h2 className='text-[#240D4B] font-bold text-[30px] md:text-[32px] '>Live & personalised deals with jaw dropping videos </h2>
                        ...
                        <div className="slider-container">
                            ...
                            >
                                <div key={1} className='px-4 '>
                                    ...
                                    <p className='mt-5 italic text-[18px] text-[black] font-semibold'>"Help me plan a 6‑day romantic luxury wellness & adventure escape in Japan for 2 people that includes daily zen meditation sessions, a private guided hike on Mt. Fuji’s scenic trails, intimate onsen soaks, a sushi‑making masterclass and boutique stays for October"</p>
...
export default LivePersonlised